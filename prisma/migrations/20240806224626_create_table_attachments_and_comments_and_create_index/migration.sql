...
-- CreateIndex
CREATE INDEX "comments_answerId_questionId_idx" ON "comments"("answerId", "questionId");

-- CreateIndex
CREATE INDEX "attachments_answerId_questionId_idx" ON "attachments"("answerId", "questionId");
